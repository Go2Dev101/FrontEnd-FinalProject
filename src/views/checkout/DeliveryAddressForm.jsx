    ...
    <>
      <Boxer>
        <section className="flex justify-between">
          <CheckOutHeader header={"Delivery Address"} title={"Please fill out your address"} />
        ...
        <section className="flex flex-1/2 justify-between gap-10  ">
          <div className="flex-1/2  ">
            <div className="flex flex-col">
              <div className=" button space-x-4 flex justify-between mb-6">
                <button className="bg-primary-700 text-white rounded-3xl cursor-pointer px-4">
                  Delivery Address
                </button>
                <button className="bg-white text-primary-700 rounded-3xl cursor-pointer px-4">
                  Pickup Point
                </button>
              </div>
              <div className=" bg-white flex flex-col mb-3 p-8 rounded-xl">
                ...
                <p className="text-xl">51/233 M.5 T.Bangyai A.Bangyai Nonthaburi</p>
          ...
          <div className="flex-1/2   bg-white flex flex-col mb-3 p-8 rounded-xl">
            ...
            <button className="bg-primary-700 text-white rounded-3xl cursor-pointer px-4 shadow-gray-500 font-bold">Proceed Payment</button>
            <button className="bg-white text-primary-700 rounded-3xl cursor-pointer px-4 mt-7 shadow-gray-500 font-bold">Back</button>
